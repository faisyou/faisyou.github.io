...
export default {
    ...
    addChatMessageWithOriginal(sender,message,original,purpose) {
        
        let chatMsg = document.createElement('p');
        chatMsg.id='translated-message';
        chatMsg.textContent = sender + ': ' + message;
        let chatMsgOrig=document.createElement('p');
        chatMsgOrig.style.fontStyle='italic';
        chatMsgOrig.textContent= sender + ': ' +original;
        chatMsgOrig.id='original-message';
        chatMsgOrig.style.display = 'none';

        let container = document.createElement('div');
        container.appendChild(chatMsg);
        container.appendChild(chatMsgOrig);
        container.className = 'chat-message ' + purpose;
        
        container.addEventListener("mouseover",(event)=>{
            
            chatMsgOrig.style.display = 'block';
        ...
        /*
        let origMsgContainer=document.createElement('div');
        origMsgContainer.append(chatMsgOrig);
        */
